...
import { Calculator, DollarSign, TrendingUp, Users, MapPin, CheckCircle, XCircle } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Card, CardContent } from '@/components/ui/card'
import { Header } from '@/components/layout/Header'
import Footer from '../layout/Footer'

export default function CupcakePricingGuideArticle() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        <nav className="text-sm text-gray-600 mb-6">
          <Link href="/">Home</Link> → <Link href="/blog">Blog</Link> → Cupcake Pricing Guide
        </nav>
        ...
        <div className="flex gap-4 text-gray-600 mb-8 pb-8 border-b">
          <span>Feb 1, 2025</span> • <span>17 min read</span> • <span className="text-rose-600 font-semibold">Pricing Strategy</span>
        </div>
